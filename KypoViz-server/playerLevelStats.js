...
var filePath = "all-events.json"

var originalDataset = require("./"+filePath);
...
function getLevelTimes() {
 ...
 function combineResults() {
  ...
  // Write stats into new file 
  jsonfile.writeFile(filePath.slice(0,-5) + '-stats' + ".json", stats, {spaces: 2}, function (err) {
            if(err) {
              console.error(err);  
          } else {
